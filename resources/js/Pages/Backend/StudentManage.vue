    ...
    <div class="w-[80%] mb-5 mt-5 flex flex-col justify-between items-center gap-10">
      ...
      <div class="w-full h-[385px] flex flex-col">
        ...
        <div class="w-full h-[55px] bg-[#5D8BA3] flex text-[24px]">
          <div class="flex-[0.2] ps-5 border font-semibold flex items-center">學員名稱</div>
        ...
        <!-- 內容 -->
        <div v-for="(item, index) in studentData?.data ?? []" :key="index" :class="{ 'bg-red-200': item.status === '停權' }" class="w-full h-[55px] bg-[#ABC2CE] flex text-[20px]">
