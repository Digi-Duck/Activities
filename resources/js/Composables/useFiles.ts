...
interface CanvasImg extends CtxParam {
 ...
 * @return {Promise<string[]>} 回傳base64的陣列
 */
 ...
 * @return {Promise<string>} 回傳壓縮好的base64圖檔
 */
 ...
 * @param {string} base64 要壓縮的base64圖檔
 * @param {number} wantWidth 圖片想要輸出的寬度
 * @return {Promise<CanvasImg>} 回傳Canvas相關資訊的物件
 */
