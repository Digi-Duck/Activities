...
const changePage = (page) => {
  ...
  const requestParam = cloneDeep(otherParam);
...
<template>
  <div class="pagination-component">
    <div class="pages-block">
      ...
      <div v-if="paginationNum.length" class="pages">
...
.pagination-component {
  @apply flex items-center gap-[15px] mx-auto;

  .pages-block {
    @apply flex items-center gap-5 text-xl;
